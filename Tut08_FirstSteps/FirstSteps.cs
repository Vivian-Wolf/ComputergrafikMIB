...
namespace Fusee.Tutorial.Core
{
    ...
    {   
        ...
        public override void Init()
        {
            ...
            _cubeTransform = new TransformComponent {Scale = new float3(1, 1, 1), Translation = new float3(0, 0, 0)}; //Translation = Position im Raum
        ...
        public override void RenderAFrame()
        {
            ...
            _camAngle = _camAngle + 90.0f * M.Pi/180.0f * DeltaTime;    //Drehung von 90° pro Sekunde, egal wie mit vielen Frames die Animation läuft

            // Setup the camera 
            RC.View = float4x4.CreateTranslation(0, 0, 50) * float4x4.CreateRotationY(_camAngle);

            // Animate the cube
            _cubeTransform.Translation = new float3(0, 2 * M.Sin(1.75f * TimeSinceStart), 0);
